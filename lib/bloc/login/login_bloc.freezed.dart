...
/// @nodoc
mixin _$LoginState {
  LoginModel get result => throw _privateConstructorUsedError;
...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl(
      {this.result =
          const LoginModel(code: 0, message: "", data: null, error: "")});
  ...
  @override
  String toString() {
    return 'LoginState(result: $result)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState({final LoginModel result}) = _$LoginStateImpl;

  @override
  LoginModel get result;
  @override
  @JsonKey(ignore: true)
  _$$LoginStateImplCopyWith<_$LoginStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
